        ...
        with open(file_path, 'r') as OpenfileToRead:
            try:
                ...
                if InputCSVdialect.delimiter != ',':
                    ...
                    summation_amount = 0
                    for eachRowOfCSVFile in CSVDataReader:
                        if eachRowOfCSVFile['product'] == productToSearch:
                            summation_amount += int(eachRowOfCSVFile['amount'])
